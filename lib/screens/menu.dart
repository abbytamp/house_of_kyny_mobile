...
class MyHomePage extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Explore Your Style with House of Kyny',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 18.0,
                      ),
  ...
  final List<ItemHomepage> items = [
    ItemHomepage("Lihat Product", Icons.store, Colors.blueGrey),
    ItemHomepage("Tambah Product", Icons.add, const Color.fromARGB(255, 216, 158, 234)),
